...
lola::vx::v4::Chip convert_to_chip_impl(
    DumperDone const& dumperdone, std::optional<lola::vx::v4::Chip> const& previous)
{
	typedef
	    typename haldls::vx::detail::BackendContainerTrait<lola::vx::v4::Chip>::default_container
	...
	if (previous) {
		...
		haldls::vx::visit_preorder(
		    *previous, halco::hicann_dls::vx::v4::ChipOnDLS(),
	...
	constexpr auto backend =
	    haldls::vx::detail::BackendContainerTrait<lola::vx::v4::Chip>::default_backend;
	...
	lola::vx::v4::Chip chip;
	words_type words;
	haldls::vx::visit_preorder(
	    chip, halco::hicann_dls::vx::v4::ChipOnDLS(), stadls::EncodeVisitor<words_type>{words});
	addresses_type addresses;
	haldls::vx::visit_preorder(
	    chip, halco::hicann_dls::vx::v4::ChipOnDLS(),
	...
	haldls::vx::visit_preorder(
	    chip, halco::hicann_dls::vx::v4::ChipOnDLS(), stadls::DecodeVisitor<words_type>{words});
	return chip;
}
