...
lola::vx::v1::Chip convert_to_chip_impl(
    DumperDone const& dumperdone, std::optional<lola::vx::v1::Chip> const& previous)
{
	typedef
	    typename haldls::vx::detail::BackendContainerTrait<lola::vx::v1::Chip>::default_container
	...
	if (previous) {
		...
		haldls::vx::visit_preorder(
		    *previous, halco::hicann_dls::vx::v1::ChipOnDLS(),
	...
	lola::vx::v1::Chip chip;
	words_type words;
	haldls::vx::visit_preorder(
	    chip, halco::hicann_dls::vx::v1::ChipOnDLS(), stadls::EncodeVisitor<words_type>{words});
	addresses_type addresses;
	haldls::vx::visit_preorder(
	    chip, halco::hicann_dls::vx::v1::ChipOnDLS(),
	...
	haldls::vx::visit_preorder(
	    chip, halco::hicann_dls::vx::v1::ChipOnDLS(), stadls::DecodeVisitor<words_type>{words});
	return chip;
}

} // namespace

lola::vx::v1::Chip convert_to_chip(DumperDone const& dumperdone)
{
	return convert_to_chip_impl(dumperdone, std::nullopt);
}

lola::vx::v1::Chip convert_to_chip(DumperDone const& dumperdone, lola::vx::v1::Chip const& previous)
{
...
CEREAL_CLASS_VERSION(stadls::vx::v1::DumperDone, 4)
