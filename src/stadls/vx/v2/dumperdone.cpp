...
lola::vx::v2::Chip convert_to_chip_impl(
    DumperDone const& dumperdone, std::optional<lola::vx::v2::Chip> const& previous)
{
	typedef
	    typename haldls::vx::detail::BackendContainerTrait<lola::vx::v2::Chip>::default_container
	...
	if (previous) {
		...
		haldls::vx::visit_preorder(
		    *previous, halco::hicann_dls::vx::v2::ChipOnDLS(),
	...
	words_type words;
	haldls::vx::visit_preorder(
	    chip, halco::hicann_dls::vx::v2::ChipOnDLS(), stadls::EncodeVisitor<words_type>{words});
	addresses_type addresses;
	haldls::vx::visit_preorder(
	    chip, halco::hicann_dls::vx::v2::ChipOnDLS(),
	...
	haldls::vx::visit_preorder(
	    chip, halco::hicann_dls::vx::v2::ChipOnDLS(), stadls::DecodeVisitor<words_type>{words});
	return chip;
}

} // namespace

lola::vx::v2::Chip convert_to_chip(DumperDone const& dumperdone)
{
	return convert_to_chip_impl(dumperdone, std::nullopt);
}

lola::vx::v2::Chip convert_to_chip(DumperDone const& dumperdone, lola::vx::v2::Chip const& previous)
{
...
CEREAL_CLASS_VERSION(stadls::vx::v2::DumperDone, 4)
