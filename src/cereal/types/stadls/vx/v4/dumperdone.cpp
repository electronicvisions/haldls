#include "cereal/types/stadls/vx/v4/dumperdone.h"
...
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE_FREE(stadls::vx::v4::DumperDone);

CEREAL_REGISTER_DYNAMIC_INIT(stadls_vx_v4_dumperdone)
