...
void CEREAL_SERIALIZE_FUNCTION_NAME(
    Archive& ar, haldls::vx::v3::NeuronConfig& value, std::uint32_t const)
{
...
template <typename Archive>
void CEREAL_SERIALIZE_FUNCTION_NAME(Archive&, haldls::vx::v3::NeuronResetQuad&, std::uint32_t const)
{}

} // namespace cereal

EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE_FREE(haldls::vx::v3::NeuronConfig);
CEREAL_REGISTER_TYPE(haldls::vx::v3::NeuronConfig)
CEREAL_REGISTER_POLYMORPHIC_RELATION(haldls::vx::Container, haldls::vx::v3::NeuronConfig)

EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE_FREE(haldls::vx::v3::NeuronResetQuad);
CEREAL_REGISTER_TYPE(haldls::vx::v3::NeuronResetQuad)
CEREAL_REGISTER_POLYMORPHIC_RELATION(haldls::vx::Container, haldls::vx::v3::NeuronResetQuad)

EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE_FREE(haldls::vx::v3::NeuronBackendConfig);
CEREAL_REGISTER_TYPE(haldls::vx::v3::NeuronBackendConfig)
CEREAL_REGISTER_POLYMORPHIC_RELATION(haldls::vx::Container, haldls::vx::v3::NeuronBackendConfig)

CEREAL_REGISTER_DYNAMIC_INIT(haldls_vx_v3_neuron)
CEREAL_REGISTER_POLYMORPHIC_RELATION(haldls::vx::Encodable, haldls::vx::v3::NeuronConfig)
CEREAL_REGISTER_POLYMORPHIC_RELATION(haldls::vx::Encodable, haldls::vx::v3::NeuronResetQuad)
CEREAL_REGISTER_POLYMORPHIC_RELATION(haldls::vx::Encodable, haldls::vx::v3::NeuronBackendConfig)
