...
{
	return os
	       << (config == lola::vx::v3::AtomicNeuron::ConstantCurrent::Type::sink ? "sink"
	                                                                             : "source");
}

AtomicNeuron::ConstantCurrent::ConstantCurrent() :
    enable(false), i_offset(), type(lola::vx::v3::AtomicNeuron::ConstantCurrent::Type::source)
{}
...
{
	if (config == lola::vx::v3::AtomicNeuron::Bayesian::Operation::local)
		return os << "local";
	else if (config == lola::vx::v3::AtomicNeuron::Bayesian::Operation::AND)
		return os << "AND";
	else if (config == lola::vx::v3::AtomicNeuron::Bayesian::Operation::XNOR)
		return os << "XNOR";
	else if (config == lola::vx::v3::AtomicNeuron::Bayesian::Operation::MULLER_C)
		return os << "MULLER_C";
...
AtomicNeuron::operator haldls::vx::v3::NeuronConfig() const
{
	haldls::vx::v3::NeuronConfig neuron_config;
	...
	neuron_config.set_invert_membrane_offset(
	    constant_current.type == lola::vx::v3::AtomicNeuron::ConstantCurrent::Type::sink);
	...
	if (event_routing.analog_output !=
	    lola::vx::v3::AtomicNeuron::EventRouting::AnalogOutputMode::off) {
...
void AtomicNeuron::set_from(haldls::vx::v3::NeuronConfig const& neuron_config)
{
	...
	constant_current.type = neuron_config.get_invert_membrane_offset()
	                            ? lola::vx::v3::AtomicNeuron::ConstantCurrent::Type::sink
	                            : lola::vx::v3::AtomicNeuron::ConstantCurrent::Type::source;
...
AtomicNeuron::operator haldls::vx::v3::NeuronBackendConfig() const
{
...
void AtomicNeuron::set_from(haldls::vx::v3::NeuronBackendConfig const& neuron_backend_config)
{
