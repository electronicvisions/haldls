...
Chip const Chip::default_neuron_bypass = []() {
	...
	for (auto const block : iter_all<SynapseDriverBlockOnDLS>()) {
		...
		value.fill(haldls::vx::v1::CommonPADIBusConfig::DacenPulseExtension(
		    haldls::vx::v1::CommonPADIBusConfig::DacenPulseExtension::max));
...
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE_FREE(lola::vx::v1::Chip)
