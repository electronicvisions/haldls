...
CorrelationReset::write_addresses(CorrelationReset::coordinate_type const& coord)
{
	...
	int row_offset = coord.toSynapseRowOnSynram().toEnum() *
	                 halco::hicann_dls::vx::v2::SynapseQuadColumnOnDLS::size;
...
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v2::SynapseWeightQuad)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v2::SynapseLabelQuad)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v2::SynapseCorrelationCalibQuad)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v2::SynapseQuad)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v2::ColumnCorrelationQuad)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(
    haldls::vx::v2::ColumnCorrelationQuad::ColumnCorrelationSwitch)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v2::ColumnCurrentQuad::ColumnCurrentSwitch)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v2::ColumnCurrentQuad)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v2::CorrelationReset)

CEREAL_CLASS_VERSION(haldls::vx::v2::SynapseWeightQuad, 0)
CEREAL_CLASS_VERSION(haldls::vx::v2::SynapseLabelQuad, 0)
CEREAL_CLASS_VERSION(haldls::vx::v2::SynapseCorrelationCalibQuad, 0)
CEREAL_CLASS_VERSION(haldls::vx::v2::SynapseQuad, 0)
CEREAL_CLASS_VERSION(haldls::vx::v2::ColumnCorrelationQuad, 0)
CEREAL_CLASS_VERSION(haldls::vx::v2::ColumnCorrelationQuad::ColumnCorrelationSwitch, 0)
CEREAL_CLASS_VERSION(haldls::vx::v2::ColumnCurrentQuad::ColumnCurrentSwitch, 0)
CEREAL_CLASS_VERSION(haldls::vx::v2::ColumnCurrentQuad, 0)
CEREAL_CLASS_VERSION(haldls::vx::v2::CorrelationReset, 0)
