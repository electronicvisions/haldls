...
std::ostream& operator<<(std::ostream& os, NeuronConfig const& config)
{
	...
	<< "enable_strong_fire\t\t\t\t" << config.m_en_strong_fire << "\tincrease neuron fire output strength" << std::endl
	...
	<< "enable_synaptic_input_inhibitory_small_capacitor\t" << config.m_en_synin_inh_small_cap << "\tenable inh. synaptic input small cap" << std::endl
	<< "enable_synaptic_input_excitatory_small_capacitor\t" << config.m_en_synin_exc_small_cap << "\tenable exc. synaptic input small cap" << std::endl
	<< "enable_synaptic_input_inhibitory_high_resistance\t" << config.m_en_synin_inh_high_res << "\tenable inh. synaptic input high resisstance mode" << std::endl
	<< "enable_synaptic_input_excitatory_high_resistance\t" << config.m_en_synin_exc_high_res << "\tenable exc. synaptic input high resistance mode" << std::endl
	...
	<< "enable_leak_multiplication\t\t\t" << config.m_en_leak_mul << "\tenable multiplication (8x) of conductance in leak mode" << std::endl
	<< "enable_pause\t\t\t\t\t" << config.m_en_pause << "\tenable gating of synaptic inputs and exponential term during reset periods";
	// clang-format on
	return os;
}
