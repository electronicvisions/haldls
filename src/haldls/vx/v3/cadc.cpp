...
#ifndef __ppu__
CADC_CHANNEL_CONFIG_UNROLL(halco::hicann_dls::vx::v3::Coordinates)
#endif

#ifdef __ppu__
CADC_CHANNEL_CONFIG_UNROLL_PPU(halco::hicann_dls::vx::v3::Coordinates)
#endif
...
CADCSampleQuad::read_addresses(coordinate_type const& coord)
{
	...
	uint32_t const address_offset =
	    quad.y() * halco::hicann_dls::vx::v3::SynapseQuadColumnOnDLS::size + quad.x();
...
#ifndef __ppu__
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::CADCSampleQuad)
CEREAL_CLASS_VERSION(haldls::vx::v3::CADCChannelConfig, 0)
CEREAL_CLASS_VERSION(haldls::vx::v3::CADCSampleQuad, 0)
#endif
