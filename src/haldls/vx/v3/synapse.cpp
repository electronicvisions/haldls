...
#ifndef __ppu__
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::SynapseWeightQuad)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::SynapseLabelQuad)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::SynapseCorrelationCalibQuad)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::SynapseQuad)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::ColumnCorrelationQuad)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(
    haldls::vx::v3::ColumnCorrelationQuad::ColumnCorrelationSwitch)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::ColumnCurrentQuad::ColumnCurrentSwitch)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::ColumnCurrentQuad)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::CorrelationReset)

CEREAL_CLASS_VERSION(haldls::vx::v3::SynapseWeightQuad, 0)
CEREAL_CLASS_VERSION(haldls::vx::v3::SynapseLabelQuad, 0)
CEREAL_CLASS_VERSION(haldls::vx::v3::SynapseCorrelationCalibQuad, 0)
CEREAL_CLASS_VERSION(haldls::vx::v3::SynapseQuad, 0)
CEREAL_CLASS_VERSION(haldls::vx::v3::ColumnCorrelationQuad, 0)
CEREAL_CLASS_VERSION(haldls::vx::v3::ColumnCorrelationQuad::ColumnCorrelationSwitch, 0)
CEREAL_CLASS_VERSION(haldls::vx::v3::ColumnCurrentQuad::ColumnCurrentSwitch, 0)
CEREAL_CLASS_VERSION(haldls::vx::v3::ColumnCurrentQuad, 0)
CEREAL_CLASS_VERSION(haldls::vx::v3::CorrelationReset, 0)
#endif
