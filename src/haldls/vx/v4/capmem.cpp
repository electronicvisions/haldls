...
#ifndef __ppu__
CAPMEM_CELL_UNROLL(halco::hicann_dls::vx::v4::Coordinates)
CAPMEM_BLOCK_UNROLL(halco::hicann_dls::vx::v4::Coordinates)
CAPMEM_BLOCK_CONFIG_UNROLL(halco::hicann_dls::vx::v4::Coordinates)
#endif

#ifdef __ppu__
CAPMEM_CELL_UNROLL_PPU(halco::hicann_dls::vx::v4::Coordinates)
CAPMEM_BLOCK_UNROLL_PPU(halco::hicann_dls::vx::v4::Coordinates)
CAPMEM_BLOCK_CONFIG_UNROLL_PPU(halco::hicann_dls::vx::v4::Coordinates)
#endif
...
EXPLICIT_INSTANTIATE_HALDLS_CONTAINER_BASE(haldls::vx::v4::ReferenceGeneratorConfig)
