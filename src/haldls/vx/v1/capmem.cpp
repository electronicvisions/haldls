...
#ifdef __ppu__
CAPMEM_CELL_UNROLL_PPU(halco::hicann_dls::vx::v1::Coordinates)
CAPMEM_BLOCK_UNROLL_PPU(halco::hicann_dls::vx::v1::Coordinates)
CAPMEM_BLOCK_CONFIG_UNROLL_PPU(halco::hicann_dls::vx::v1::Coordinates)
#endif
