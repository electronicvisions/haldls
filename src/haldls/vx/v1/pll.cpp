...
#ifndef __ppu__
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v1::PLLClockOutputBlock)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v1::PLLClockOutputBlock::ClockOutput)
CEREAL_CLASS_VERSION(haldls::vx::v1::PLLClockOutputBlock, 0)
CEREAL_CLASS_VERSION(haldls::vx::v1::PLLClockOutputBlock::ClockOutput, 0)
#endif
