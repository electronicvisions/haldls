...
{
	haldls::vx::v1::PLLClockOutputBlock config;
	...
	haldls::vx::v1::PLLClockOutputBlock config_eq = config;
	haldls::vx::v1::PLLClockOutputBlock config_default;
...
TEST(PLLClockOutputBlock, EncodeDecode)
{
	...
	// JTAG write access
	{
		std::array<JTAGPLLRegisterOnDLS, haldls::vx::v1::PLLClockOutputBlock::config_size_in_words>
		    ref_addresses = {JTAGPLLRegisterOnDLS(4)};
		std::array<
		    fisch::vx::word_access_type::JTAGPLLRegister,
		    haldls::vx::v1::PLLClockOutputBlock::config_size_in_words>
	...
	// Omnibus over JTAG access
	{
		...
		haldls::vx::v1::PLLClockOutputBlock config_2;
		visit_preorder(
		    config_2, coord,
...
{
	haldls::vx::v1::PLLClockOutputBlock obj1, obj2;
	for (auto output : iter_all<PLLClockOutputOnDLS>()) {
