...
#include "lola/vx/v2/morphology.h"
...
{
	typedef halco::hicann_dls::vx::v2::AtomicNeuronOnLogicalNeuron coord;
	typedef halco::hicann_dls::vx::v2::NeuronColumnOnLogicalNeuron column;
	typedef halco::hicann_dls::vx::v2::NeuronRowOnLogicalNeuron row;
...
TEST(LogicalNeuron, Multicompartment)
{
	...
	typedef halco::hicann_dls::vx::v2::CompartmentOnLogicalNeuron comp_coord;
