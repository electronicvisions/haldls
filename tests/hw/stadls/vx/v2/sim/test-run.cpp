...
TEST(Run, ExecutableRestriction)
{
	...
	sim_builder.read(halco::hicann_dls::vx::v2::CrossbarNodeOnDLS());
	sim_builder.block_until(
	    halco::hicann_dls::vx::v2::BarrierOnFPGA(), haldls::vx::Barrier::omnibus);
	...
	hw_builder.read(halco::hicann_dls::vx::v2::NeuronConfigOnDLS());
