...
namespace haldls::vx {
CAPMEM_EXTERN_TEMPLATE(halco::hicann_dls::vx::v2::Coordinates)
} // namespace haldls::vx

namespace std {
CAPMEM_HALCO_GEOMETRY_HASH(halco::hicann_dls::vx::v2::Coordinates)
} // namespace std

namespace haldls::vx::v2 GENPYBIND_TAG_HALDLS_VX_V2 {

using CapMemCell GENPYBIND(opaque) = haldls::vx::CapMemCell<halco::hicann_dls::vx::v2::Coordinates>;

GENPYBIND_MANUAL({
	auto cls = pybind11::class_<::haldls::vx::v2::CapMemCell::value_type>(
	    parent, "_CapMemCell_value_type");
	cls.def(
	       pybind11::init<::haldls::vx::v2::CapMemCell::Value>(),
	       pybind11::arg("value") = ::haldls::vx::v2::CapMemCell::Value(0))
	    .def(
	        pybind11::init<::haldls::vx::v2::CapMemCell::DisableRefresh>(), pybind11::arg("value"));
	parent.attr("CapMemCell").attr("value_type") = parent.attr("_CapMemCell_value_type");
})

using CapMemBlock GENPYBIND(opaque) =
    haldls::vx::CapMemBlock<halco::hicann_dls::vx::v2::Coordinates>;
using CapMemBlockConfig GENPYBIND(opaque) =
    haldls::vx::CapMemBlockConfig<halco::hicann_dls::vx::v2::Coordinates>;
...
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v2::ReferenceGeneratorConfig::CapMemAmplifier)
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v2::ReferenceGeneratorConfig::CapMemOffset)
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v2::ReferenceGeneratorConfig::CapMemSlope)
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v2::ReferenceGeneratorConfig::ReferenceControl)
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v2::ReferenceGeneratorConfig::ResistorControl)

} // namespace std

EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v2::ReferenceGeneratorConfig)
