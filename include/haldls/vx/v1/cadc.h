...
namespace haldls::vx {
CADC_EXTERN_TEMPLATE(halco::hicann_dls::vx::v1::Coordinates)
} // namespace haldls::vx
...
using CADCChannelConfig GENPYBIND(opaque) =
    haldls::vx::CADCChannelConfig<halco::hicann_dls::vx::v1::Coordinates>;
...
public:
	...
	typedef halco::hicann_dls::vx::v1::CADCSampleQuadOnDLS coordinate_type;
...
template <>
struct BackendContainerTrait<v1::CADCSampleQuad>
    : public BackendContainerBase<v1::CADCSampleQuad, fisch::vx::word_access_type::Omnibus>
{};

} // namespace haldls::vx::detail

EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v1::CADCSampleQuad)
