...
namespace haldls::vx {
CAPMEM_EXTERN_TEMPLATE(halco::hicann_dls::vx::v4::Coordinates)
} // namespace haldls::vx

namespace std {
CAPMEM_HALCO_GEOMETRY_HASH(halco::hicann_dls::vx::v4::Coordinates)
} // namespace std
...
GENPYBIND_MANUAL({
	auto cls = pybind11::class_<::haldls::vx::v4::CapMemCell::value_type>(
	    parent, "_CapMemCell_value_type");
	cls.def(
	       pybind11::init<::haldls::vx::v4::CapMemCell::Value>(),
	       pybind11::arg("value") = ::haldls::vx::v4::CapMemCell::Value(0))
	    .def(
	        pybind11::init<::haldls::vx::v4::CapMemCell::DisableRefresh>(), pybind11::arg("value"));
...
template <>
struct BackendContainerTrait<v4::ReferenceGeneratorConfig>
    : public BackendContainerBase<
          v4::ReferenceGeneratorConfig,
...
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v4::ReferenceGeneratorConfig::CapMemAmplifier)
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v4::ReferenceGeneratorConfig::CapMemOffset)
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v4::ReferenceGeneratorConfig::CapMemSlope)
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v4::ReferenceGeneratorConfig::ReferenceControl)
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v4::ReferenceGeneratorConfig::ResistorControl)
