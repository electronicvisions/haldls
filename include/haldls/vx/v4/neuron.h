...
using NeuronBackendConfig GENPYBIND(opaque, inline_base("*ContainerBase*")) =
    haldls::vx::NeuronBackendConfig<halco::hicann_dls::vx::v4::Coordinates>;
 ...
 * is reset. This behaviour will be fixed for HX-v4 (issue 3346).
 */
...
template <>
struct BackendContainerTrait<v4::NeuronConfig>
...
template <>
struct BackendContainerTrait<v4::NeuronResetQuad>
    : public BackendContainerBase<
          v4::NeuronResetQuad,
          fisch::vx::word_access_type::Omnibus,
          fisch::vx::word_access_type::OmnibusChipOverJTAG>
