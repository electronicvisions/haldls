...
{
public:
	typedef halco::hicann_dls::vx::v3::SynapseWeightQuadOnDLS coordinate_type;
...
private:
	...
	friend struct haldls::vx::detail::VisitPreorderImpl<lola::vx::v3::SynapseWeightRow>;
	friend struct haldls::vx::detail::VisitPreorderImpl<lola::vx::v3::SynapseWeightMatrix>;
...
{
public:
	typedef halco::hicann_dls::vx::v3::SynapseLabelQuadOnDLS coordinate_type;
	typedef std::true_type is_leaf_node;
...
private:
	// used for direct member access without function calls
	friend struct haldls::vx::detail::VisitPreorderImpl<lola::vx::v3::SynapseLabelRow>;
	friend struct haldls::vx::detail::VisitPreorderImpl<lola::vx::v3::SynapseLabelMatrix>;
	friend class cereal::access;
	template <class Archive>
	void serialize(Archive& ar, std::uint32_t version);
...
{
public:
	typedef halco::hicann_dls::vx::v3::SynapseCorrelationCalibQuadOnDLS coordinate_type;
	typedef std::true_type is_leaf_node;
...
private:
	// used for direct member access without function calls
	friend struct haldls::vx::detail::VisitPreorderImpl<lola::vx::v3::SynapseCorrelationCalibRow>;
...
{
public:
	typedef halco::hicann_dls::vx::v3::SynapseQuadOnDLS coordinate_type;
	typedef std::true_type is_leaf_node;
...
private:
	...
	// used for direct member access without function calls
	friend struct haldls::vx::detail::VisitPreorderImpl<lola::vx::v3::SynapseMatrix>;
	friend struct haldls::vx::detail::VisitPreorderImpl<lola::vx::v3::SynapseRow>;
...
{
public:
	typedef halco::hicann_dls::vx::v3::ColumnCorrelationQuadOnDLS coordinate_type;
	typedef std::true_type is_leaf_node;
...
private:
	...
	friend struct haldls::vx::detail::VisitPreorderImpl<lola::vx::v3::ColumnCorrelationRow>;
};

class GENPYBIND(visible) ColumnCurrentQuad : public DifferentialWriteTrait
{
public:
	typedef halco::hicann_dls::vx::v3::ColumnCurrentQuadOnDLS coordinate_type;
	typedef std::true_type is_leaf_node;
...
private:
	...
	friend struct haldls::vx::detail::VisitPreorderImpl<lola::vx::v3::ColumnCurrentRow>;
};
...
{
public:
	typedef halco::hicann_dls::vx::v3::CorrelationResetOnDLS coordinate_type;
	typedef std::true_type is_leaf_node;
...
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v3::SynapseWeightQuad::Value)
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v3::SynapseCorrelationCalibQuad::TimeCalib)
HALCO_GEOMETRY_HASH_CLASS(haldls::vx::v3::SynapseCorrelationCalibQuad::AmpCalib)

} // namespace std

EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::SynapseWeightQuad)
EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::SynapseLabelQuad)
EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::SynapseCorrelationCalibQuad)
EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::SynapseQuad)
EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::ColumnCorrelationQuad)
EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::ColumnCorrelationQuad::ColumnCorrelationSwitch)
EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::ColumnCurrentQuad::ColumnCurrentSwitch)
EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::ColumnCurrentQuad)
EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::CorrelationReset)
