...
template <>
struct BackendContainerTrait<v3::CommonCorrelationConfig>
...
CEREAL_CLASS_VERSION(haldls::vx::v3::CommonCorrelationConfig, 1)
EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::CommonCorrelationConfig)
