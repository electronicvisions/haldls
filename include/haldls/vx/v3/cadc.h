...
namespace haldls::vx {
CADC_EXTERN_TEMPLATE(halco::hicann_dls::vx::v3::Coordinates)
} // namespace haldls::vx
...
using CADCChannelConfig GENPYBIND(opaque) =
    haldls::vx::CADCChannelConfig<halco::hicann_dls::vx::v3::Coordinates>;
...
public:
	...
	typedef halco::hicann_dls::vx::v3::CADCSampleQuadOnDLS coordinate_type;
...
template <>
struct BackendContainerTrait<v3::CADCSampleQuad>
    : public BackendContainerBase<v3::CADCSampleQuad, fisch::vx::word_access_type::Omnibus>
{};

} // namespace haldls::vx::detail

EXTERN_INSTANTIATE_CEREAL_SERIALIZE(haldls::vx::v3::CADCSampleQuad)
