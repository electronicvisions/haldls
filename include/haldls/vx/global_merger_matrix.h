...
{
public:
	typedef halco::hicann_dls::vx::GlobalMergerMatrixOutputConfigOnDLS coordinate_type;
	...
	typedef halco::common::
	    typed_array<bool, halco::hicann_dls::vx::GlobalMergerMatrixOutputChannelOnDLS>
...
{
public:
	typedef halco::hicann_dls::vx::GlobalMergerMatrixInputDropCounterOnDLS coordinate_type;
	typedef std::true_type is_leaf_node;
...
{
public:
	typedef halco::hicann_dls::vx::GlobalMergerMatrixOutputEventCounterOnDLS coordinate_type;
	typedef std::true_type is_leaf_node;
...
{
public:
	typedef halco::hicann_dls::vx::GlobalMergerMatrixNodeOnDLS coordinate_type;
	typedef std::true_type is_leaf_node;
#ifndef __ppu__
	constexpr static auto unsupported_read_targets GENPYBIND(hidden) = {
	    hxcomm::vx::Target::hardware};
	...
	constexpr static size_t IDX_WIDTH =
	    GMM_WIDTH - hate::math::num_bits(halco::hicann_dls::vx::SpikeLabel::max);
...
{
public:
	typedef halco::hicann_dls::vx::NeuronLabelToGL1EventLUTEntryOnDLS coordinate_type;
	typedef std::true_type is_leaf_node;
#ifndef __ppu__
	constexpr static auto unsupported_read_targets GENPYBIND(hidden) = {
	    hxcomm::vx::Target::hardware};
	...
	halco::hicann_dls::vx::SpikeLabel::GlobalMergerMatrixMutable get_global_merger_matrix_mutable()
	    const SYMBOL_VISIBLE;
	GENPYBIND(setter_for(global_merger_matrix_mutable))
	void set_global_merger_matrix_mutable(
	    halco::hicann_dls::vx::SpikeLabel::GlobalMergerMatrixMutable value) SYMBOL_VISIBLE;
...
private:
	...
	halco::hicann_dls::vx::SpikeLabel::GlobalMergerMatrixMutable m_global_merger_matrix_mutable;
...
template <>
struct BackendContainerTrait<GlobalMergerMatrixOutputConfig>
...
template <>
struct BackendContainerTrait<GlobalMergerMatrixInputDropCounter>
    : public BackendContainerBase<
...
template <>
struct BackendContainerTrait<GlobalMergerMatrixOutputEventCounter>
    : public BackendContainerBase<
...
template <>
struct BackendContainerTrait<GlobalMergerMatrixNode>
    : public BackendContainerBase<
...
template <>
struct BackendContainerTrait<NeuronLabelToGL1EventLUTEntry>
    : public BackendContainerBase<
