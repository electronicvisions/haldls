...
public:
	...
	typedef v1::PlaybackProgramBuilder Builder;
	...
	haldls::vx::v1::PLLClockOutputBlock pll_clock_output_block;

	/** ADPLL setting. */
	typedef halco::common::typed_array<haldls::vx::ADPLL, halco::hicann_dls::vx::v1::ADPLLOnDLS>
	...
	struct GENPYBIND(visible) HighspeedLink
	{
		...
		typedef halco::common::
		    typed_array<haldls::vx::PhyConfigFPGA, halco::hicann_dls::vx::v1::PhyConfigFPGAOnDLS>
		...
		typedef halco::common::
		    typed_array<haldls::vx::PhyConfigChip, halco::hicann_dls::vx::v1::PhyConfigChipOnDLS>
	...
	haldls::vx::v1::ReferenceGeneratorConfig reference_generator_config;
