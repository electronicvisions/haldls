...
#include "stadls/vx/v4/playback_generator.h"
...
public:
	...
	struct GENPYBIND(visible) HighspeedLink
	{
		...
		typedef halco::common::
		    typed_array<haldls::vx::PhyConfigFPGA, halco::hicann_dls::vx::v4::PhyConfigFPGAOnDLS>
		...
		typedef halco::common::
		    typed_array<haldls::vx::PhyConfigChip, halco::hicann_dls::vx::v4::PhyConfigChipOnDLS>
	...
	typedef halco::common::typed_array<
	    ...
	    halco::hicann_dls::vx::v4::CapMemBlockConfigOnDLS>
	...
	typedef halco::common::
	    typed_array<haldls::vx::v4::CapMemBlock, halco::hicann_dls::vx::v4::CapMemBlockOnDLS>
...
public:
	...
	typedef halco::common::typed_array<
	    haldls::vx::v4::ColumnCorrelationQuad,
	    halco::hicann_dls::vx::v4::ColumnCorrelationQuadOnDLS>
	...
	typedef halco::common::typed_array<
	    haldls::vx::v4::ColumnCurrentQuad,
	    halco::hicann_dls::vx::v4::ColumnCurrentQuadOnDLS>
	...
	typedef halco::common::typed_array<
	    haldls::vx::v4::CommonCorrelationConfig,
	    halco::hicann_dls::vx::v4::CommonCorrelationConfigOnDLS>
...
GENPYBIND_MANUAL({
	parent.def(
	    "generate",
	    [](::stadls::vx::v4::ExperimentInit const& seq) {
...
GENPYBIND_MANUAL({
	parent.def(
	    "generate",
	    [](::stadls::vx::v4::DigitalInit const& seq) {
		    return ::stadls::vx::detail::py_generate_impl(seq);
	    },
	    pybind11::return_value_policy::move);
})
