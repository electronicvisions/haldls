...
template <>
void decode_random(std::mt19937& gen, haldls::vx::v3::CapMemBlockConfig& config)
{
	typedef haldls::vx::detail::BackendContainerTrait<
	    haldls::vx::v3::CapMemBlockConfig>::default_container word_type;
	...
	std::uniform_int_distribution<uintmax_t> hotbit_capmem_row(
	    0, halco::hicann_dls::vx::v3::CapMemRowOnCapMemBlock::max);
	...
	std::uniform_int_distribution<uintmax_t> capmem_column(
	    0, halco::hicann_dls::vx::v3::CapMemColumnOnCapMemBlock::max);
	...
	std::uniform_int_distribution<uintmax_t> prescale_ramp(
	    0, haldls::vx::v3::CapMemBlockConfig::PrescaleRamp::max);
	std::uniform_int_distribution<uintmax_t> prescale_pause(
	    0, haldls::vx::v3::CapMemBlockConfig::PrescalePause::max);
...
template <>
void decode_ones(haldls::vx::v3::CapMemBlockConfig& /* config */)
{
