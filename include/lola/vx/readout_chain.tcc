...
struct VisitPreorderImpl<lola::vx::CHIP_REVISION_STR::ReadoutChain>
{
	...
	static void call(
	    hate::Empty<lola::vx::CHIP_REVISION_STR::ReadoutChain> const& config,
	    ...
	    VisitorT&& visitor)
	{
		...
		hate::Empty<ReadoutSourceSelection> dynamic_mux_config;
		visit_preorder(dynamic_mux_config, ReadoutSourceSelectionOnDLS(), visitor);
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_out_amp_i_bias_0;
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_out_amp_i_bias_1;
		...
		hate::Empty<MADCConfig> madc_config;

		// dynamic_mux
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_ac_mux_i_bias;
		visit_preorder(cell_ac_mux_i_bias, CapMemCellOnDLS::readout_ac_mux_i_bias, visitor);

		// pseudo_diff_converter
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_pseudo_diff_v_ref;
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_pseudo_diff_buffer_bias;
		...
		// madc_preamp
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_sc_amp_v_ref;
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_sc_amp_i_bias;
		...
		// madc
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_madc_in_500na;
		...
		for (auto mux : halco::common::iter_all<PadMultiplexerConfigOnDLS>()) {
			hate::Empty<PadMultiplexerConfig> pad_multiplexer_config;
			visit_preorder(pad_multiplexer_config, mux, visitor);
		}

		// source measure unit
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_iconv_sc_amp_v_ref;
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_iconv_sc_amp_i_bias;
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_iconv_test_voltage;
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_iconv_i_bias_buffer;
		visit_preorder(
		...
		hate::Empty<CurrentDAC> dac_config;

		// current_dac
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_idac_i_bias;
		hate::Empty<haldls::vx::CHIP_REVISION_STR::CapMemCell> cell_idac_i_bias_casc;
	...
	static void call(
	    ContainerT& config,
	    hate::Empty<lola::vx::CHIP_REVISION_STR::ReadoutChain::coordinate_type> const& coord,
	    VisitorT&& visitor)
	{
		using namespace halco::hicann_dls::vx::CHIP_REVISION_STR;
		using namespace haldls::vx::CHIP_REVISION_STR;
		...
		visit_preorder(dynamic_mux_config, hate::Empty<ReadoutSourceSelectionOnDLS>{}, visitor);
		...
		visit_preorder(cell_out_amp_i_bias_0, hate::Empty<CapMemCellOnDLS>{}, visitor);
		visit_preorder(cell_out_amp_i_bias_1, hate::Empty<CapMemCellOnDLS>{}, visitor);
		...
		visit_preorder(cell_ac_mux_i_bias, hate::Empty<CapMemCellOnDLS>{}, visitor);
		...
		visit_preorder(cell_pseudo_diff_v_ref, hate::Empty<CapMemCellOnDLS>{}, visitor);
		visit_preorder(cell_pseudo_diff_buffer_bias, hate::Empty<CapMemCellOnDLS>{}, visitor);
		...
		visit_preorder(cell_sc_amp_v_ref, hate::Empty<CapMemCellOnDLS>{}, visitor);
		visit_preorder(cell_sc_amp_i_bias, hate::Empty<CapMemCellOnDLS>{}, visitor);
		...
		visit_preorder(cell_madc_in_500na, hate::Empty<CapMemCellOnDLS>{}, visitor);

		// pad_mux
		for (auto mux : halco::common::iter_all<PadMultiplexerConfigOnDLS>()) {
			visit_preorder(config.pad_mux[mux], hate::Empty<PadMultiplexerConfigOnDLS>{}, visitor);
		}
		...
		visit_preorder(cell_iconv_sc_amp_v_ref, hate::Empty<CapMemCellOnDLS>{}, visitor);
		visit_preorder(cell_iconv_sc_amp_i_bias, hate::Empty<CapMemCellOnDLS>{}, visitor);
		visit_preorder(cell_iconv_test_voltage, hate::Empty<CapMemCellOnDLS>{}, visitor);
		visit_preorder(cell_iconv_i_bias_buffer, hate::Empty<CapMemCellOnDLS>{}, visitor);
		...
		visit_preorder(cell_idac_i_bias, hate::Empty<CapMemCellOnDLS>{}, visitor);
		visit_preorder(cell_idac_i_bias_casc, hate::Empty<CapMemCellOnDLS>{}, visitor);
		visit_preorder(dac_config, hate::Empty<CurrentDACOnDLS>{}, visitor);

		visit_preorder(madc_config, hate::Empty<MADCConfigOnDLS>{}, visitor);
