...
template <>
struct BackendContainerTrait<lola::vx::v4::Chip>
    : public BackendContainerBase<lola::vx::v4::Chip, fisch::vx::word_access_type::Omnibus>
{};

template <>
struct VisitPreorderImpl<lola::vx::v4::Chip>
{
	template <typename ContainerT, typename VisitorT>
	static void call(
	    hate::Empty<ContainerT> const& config,
	    lola::vx::v4::Chip::coordinate_type const& coord,
	    VisitorT&& visitor)
	{
