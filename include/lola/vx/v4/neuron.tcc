...
template <>
struct BackendContainerTrait<lola::vx::v4::AtomicNeuron>
...
template <>
struct VisitPreorderImpl<lola::vx::v4::AtomicNeuron>
{
	template <typename ContainerT, typename VisitorT>
	static void call(
	    hate::Empty<ContainerT> const& config,
	    lola::vx::v4::AtomicNeuron::coordinate_type const& coord,
	    VisitorT&& visitor)
	{
		...
		hate::Empty<haldls::vx::v4::NeuronConfig> neuron_config;
		visit_preorder(neuron_config, coord.toNeuronConfigOnDLS(), visitor);

		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_synin_exc_tau;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_synin_exc_coba;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_synin_exc_shift;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_synin_exc_gm;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_e_synin_exc_rev;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_synin_inh_tau;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_synin_inh_coba;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_synin_inh_shift;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_synin_inh_gm;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_e_synin_inh_rev;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_v_leak;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_leak;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_v_reset;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_reset;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_v_threshold;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_offset;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_v_ref_adapt;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_v_leak_adapt;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_adapt_tau;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_adapt_a;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_adapt_b;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_v_exp;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_exp;
		hate::Empty<haldls::vx::v4::CapMemCell> cell_i_bias_nmda;
		...
		hate::Empty<haldls::vx::v4::NeuronBackendConfig> neuron_backend_config;
	...
	static void call(
	    ContainerT& config,
	    hate::Empty<lola::vx::v4::AtomicNeuron::coordinate_type> const& coord,
	    VisitorT&& visitor)
	{
		using halco::common::iter_all;
		using namespace halco::hicann_dls::vx::v4;
		...
		auto neuron_config = static_cast<haldls::vx::v4::NeuronConfig>(config);
		visit_preorder(neuron_config, hate::Empty<NeuronConfigOnDLS>{}, visitor);

		haldls::vx::v4::CapMemCell cell_i_bias_synin_exc_tau(config.excitatory_input.i_bias_tau);
		haldls::vx::v4::CapMemCell cell_i_bias_synin_exc_coba(config.excitatory_input.i_bias_coba);
		haldls::vx::v4::CapMemCell cell_i_bias_synin_exc_shift(
		    config.excitatory_input.i_shift_reference);
		haldls::vx::v4::CapMemCell cell_i_bias_synin_exc_gm(config.excitatory_input.i_bias_gm);
		haldls::vx::v4::CapMemCell cell_e_synin_exc_rev(config.excitatory_input.v_rev_coba);
		haldls::vx::v4::CapMemCell cell_i_bias_synin_inh_tau(config.inhibitory_input.i_bias_tau);
		haldls::vx::v4::CapMemCell cell_i_bias_synin_inh_coba(config.inhibitory_input.i_bias_coba);
		haldls::vx::v4::CapMemCell cell_i_bias_synin_inh_shift(
		    config.inhibitory_input.i_shift_reference);
		haldls::vx::v4::CapMemCell cell_i_bias_synin_inh_gm(config.inhibitory_input.i_bias_gm);
		haldls::vx::v4::CapMemCell cell_e_synin_inh_rev(config.inhibitory_input.v_rev_coba);
		haldls::vx::v4::CapMemCell cell_v_leak(config.leak.v_leak);
		haldls::vx::v4::CapMemCell cell_i_bias_leak(config.leak.i_bias);
		haldls::vx::v4::CapMemCell cell_v_reset(config.reset.v_reset);
		haldls::vx::v4::CapMemCell cell_i_bias_reset(config.reset.i_bias);
		haldls::vx::v4::CapMemCell cell_v_threshold(config.threshold.v_threshold);
		haldls::vx::v4::CapMemCell cell_i_offset(config.constant_current.i_offset);
		haldls::vx::v4::CapMemCell cell_v_ref_adapt(config.adaptation.v_ref);
		haldls::vx::v4::CapMemCell cell_v_leak_adapt(config.adaptation.v_leak);
		haldls::vx::v4::CapMemCell cell_i_bias_adapt_tau(config.adaptation.i_bias_tau);
		haldls::vx::v4::CapMemCell cell_i_bias_adapt_a(config.adaptation.i_bias_a);
		haldls::vx::v4::CapMemCell cell_i_bias_adapt_b(config.adaptation.i_bias_b);
		haldls::vx::v4::CapMemCell cell_v_exp(config.exponential.v_exp);
		haldls::vx::v4::CapMemCell cell_i_bias_exp(config.exponential.i_bias);
		haldls::vx::v4::CapMemCell cell_i_bias_nmda(config.multicompartment.i_bias_nmda);
		...
		auto neuron_backend_config = static_cast<haldls::vx::v4::NeuronBackendConfig>(config);
		visit_preorder(neuron_backend_config, hate::Empty<NeuronBackendConfigOnDLS>{}, visitor);

		if constexpr (!std::is_same<ContainerT, lola::vx::v4::AtomicNeuron const>::value) {
...
template <>
struct BackendContainerTrait<lola::vx::v4::NeuronBlock>
    : public BackendContainerBase<
          lola::vx::v4::NeuronBlock,
          fisch::vx::word_access_type::Omnibus,
          fisch::vx::word_access_type::OmnibusChipOverJTAG>
{};

template <>
struct VisitPreorderImpl<lola::vx::v4::NeuronBlock>
{
	template <typename ContainerT, typename VisitorT>
	static void call(
	    hate::Empty<ContainerT>& config,
	    lola::vx::v4::NeuronBlock::coordinate_type const& coord,
	    VisitorT&& visitor)
	{
		using halco::common::iter_all;
		using namespace halco::hicann_dls::vx::v4;
		...
		for (auto const an : iter_all<AtomicNeuronOnDLS>()) {
			hate::Empty<lola::vx::v4::AtomicNeuron> atomic_neuron;
			visit_preorder(atomic_neuron, an, visitor);
		}

		for (auto const block : iter_all<CommonNeuronBackendConfigOnDLS>()) {
			hate::Empty<haldls::vx::v4::CommonNeuronBackendConfig> backend;
			visit_preorder(backend, block, visitor);
		}

		for (auto const row : iter_all<ColumnCurrentRowOnDLS>()) {
			hate::Empty<lola::vx::v4::ColumnCurrentRow> current_row;
			visit_preorder(current_row, row, visitor);
		}

		for (auto const block : iter_all<CapMemBlockOnDLS>()) {
			hate::Empty<haldls::vx::v4::CapMemCell> v_bias_casc_n;
			hate::Empty<haldls::vx::v4::CapMemCell> i_bias_readout_amp;
			hate::Empty<haldls::vx::v4::CapMemCell> i_bias_leak_source_follower;
			hate::Empty<haldls::vx::v4::CapMemCell> i_bias_threshold_comparator;
			hate::Empty<haldls::vx::v4::CapMemCell> i_bias_synin_drop;
			visit_preorder(
			    v_bias_casc_n,
	...
	static void call(
	    ContainerT& config,
	    hate::Empty<lola::vx::v4::NeuronBlock::coordinate_type> const& coord,
	    VisitorT&& visitor)
	{
		using halco::common::iter_all;
		using namespace halco::hicann_dls::vx::v4;
		...
		for (auto const block : iter_all<CapMemBlockOnDLS>()) {
			haldls::vx::v4::CapMemCell v_bias_casc_n(config.v_bias_casc_n[block]);
			haldls::vx::v4::CapMemCell i_bias_readout_amp(config.i_bias_readout_amp[block]);
			haldls::vx::v4::CapMemCell i_bias_leak_source_follower(
			    config.i_bias_leak_source_follower[block]);
			haldls::vx::v4::CapMemCell i_bias_threshold_comparator(
			    config.i_bias_threshold_comparator[block]);
			haldls::vx::v4::CapMemCell i_bias_synin_drop(config.i_bias_synin_drop[block]);
			...
			if constexpr (!std::is_same<ContainerT, lola::vx::v4::NeuronBlock const>::value) {
...
BOOST_HANA_ADAPT_STRUCT(
    lola::vx::v4::AtomicNeuron::SynapticInput,
    enable,
    i_bias_tau,
    i_bias_coba,
    i_shift_reference,
...
BOOST_HANA_ADAPT_STRUCT(lola::vx::v4::AtomicNeuron::Threshold, enable, v_threshold);

BOOST_HANA_ADAPT_STRUCT(
    lola::vx::v4::AtomicNeuron::Multicompartment,
    connect_soma,
    connect_soma_right,
    connect_right,
    connect_vertical,
...
BOOST_HANA_ADAPT_STRUCT(lola::vx::v4::AtomicNeuron::ConstantCurrent, enable, i_offset, type);

BOOST_HANA_ADAPT_STRUCT(lola::vx::v4::AtomicNeuron::MembraneCapacitance, capacitance);

BOOST_HANA_ADAPT_STRUCT(
    lola::vx::v4::AtomicNeuron::Adaptation,
    enable,
    enable_pulse,
    invert_a,
    invert_b,
...
BOOST_HANA_ADAPT_STRUCT(lola::vx::v4::AtomicNeuron::Exponential, enable, v_exp, i_bias);

BOOST_HANA_ADAPT_STRUCT(
    lola::vx::v4::AtomicNeuron::Readout,
...
BOOST_HANA_ADAPT_STRUCT(
    lola::vx::v4::AtomicNeuron::EventRouting,
    analog_output,
    enable_digital,
...
BOOST_HANA_ADAPT_STRUCT(
    lola::vx::v4::AtomicNeuron::RefractoryPeriod,
    input_clock,
    reset_holdoff,
    refractory_time,
    enable_pause);
...
BOOST_HANA_ADAPT_STRUCT(
    lola::vx::v4::AtomicNeuron::Bayesian,
    to_post_pulse,
    operation,
