...
{
public:
	typedef haldls::vx::v4::CapMemCell::Value AnalogValue GENPYBIND(visible);
	typedef haldls::vx::v4::CapMemCell::DisableRefresh AnalogDisableRefresh GENPYBIND(visible);
	...
	struct GENPYBIND(visible) EventRouting
	{
		...
		typedef haldls::vx::v4::NeuronBackendConfig::AddressOut Address GENPYBIND(visible);
	...
	{
		typedef haldls::vx::v4::NeuronConfig::ReadoutSource Source GENPYBIND(visible);
	...
	{
		typedef haldls::vx::v4::NeuronBackendConfig::InputClock InputClock GENPYBIND(visible);
		typedef haldls::vx::v4::NeuronBackendConfig::ResetHoldoff ResetHoldoff GENPYBIND(visible);
	...
	explicit operator haldls::vx::v4::NeuronConfig() const SYMBOL_VISIBLE;
	GENPYBIND_MANUAL({
		parent.def("asNeuronConfig", [](GENPYBIND_PARENT_TYPE const& self) {
			return static_cast<haldls::vx::v4::NeuronConfig>(self);
		});
	})

	void set_from(haldls::vx::v4::NeuronConfig const& neuron_config) SYMBOL_VISIBLE;

	/** Allow converting to/from a haldls neuron backend config. */
	explicit operator haldls::vx::v4::NeuronBackendConfig() const SYMBOL_VISIBLE;
	GENPYBIND_MANUAL({
		parent.def("asNeuronBackendConfig", [](GENPYBIND_PARENT_TYPE const& self) {
			return static_cast<haldls::vx::v4::NeuronBackendConfig>(self);
		});
	})

	void set_from(haldls::vx::v4::NeuronBackendConfig const& neuron_backend_config) SYMBOL_VISIBLE;
...
public:
	...
	typedef halco::common::
	    typed_heap_array<AtomicNeuron, halco::hicann_dls::vx::v4::AtomicNeuronOnDLS>
	...
	typedef halco::common::typed_array<
	    haldls::vx::v4::CommonNeuronBackendConfig,
	    halco::hicann_dls::vx::v4::CommonNeuronBackendConfigOnDLS>
	...
	typedef halco::common::typed_array<
	    lola::vx::v4::ColumnCurrentRow,
	    halco::hicann_dls::vx::v4::ColumnCurrentRowOnDLS>
	...
	typedef halco::common::
	    typed_array<AnalogValueVariant, halco::hicann_dls::vx::v4::CapMemBlockOnDLS>
	        AnalogValues;
	/**
	...
	// qualification
	GENPYBIND_MANUAL({
		auto av = parent->py::template class_<::lola::vx::v4::NeuronBlock::AnalogValues>(
		    parent, "AnalogValues");
		av.def(
		    "fill", &::lola::vx::v4::NeuronBlock::AnalogValues::fill, "", parent->py::arg("val"));
		{
			typedef ::lola::vx::v4::NeuronBlock::AnalogValues::reference (
			    ::lola::vx::v4::NeuronBlock::AnalogValues::*genpybind_at_type)(
			    const ::lola::vx::v4::NeuronBlock::AnalogValues::key_type&);
			av.def(
			    "at", (genpybind_at_type) & ::lola::vx::v4::NeuronBlock::AnalogValues::at, "",
			    parent->py::arg("key"));
		}
		{
			typedef ::lola::vx::v4::NeuronBlock::AnalogValues::const_reference (
			    ::lola::vx::v4::NeuronBlock::AnalogValues::*genpybind_at_type)(
			    const ::lola::vx::v4::NeuronBlock::AnalogValues::key_type&) const;
			av.def(
			    "at", (genpybind_at_type) & ::lola::vx::v4::NeuronBlock::AnalogValues::at, "",
			    parent->py::arg("key"));
		}
		{
			typedef ::lola::vx::v4::NeuronBlock::AnalogValues::reference (
			    ::lola::vx::v4::NeuronBlock::AnalogValues::*genpybind_front_type)();
			av.def(
			    "front", (genpybind_front_type) & ::lola::vx::v4::NeuronBlock::AnalogValues::front,
			    "");
		}
		{
			typedef ::lola::vx::v4::NeuronBlock::AnalogValues::const_reference (
			    ::lola::vx::v4::NeuronBlock::AnalogValues::*genpybind_front_type)() const;
			av.def(
			    "front", (genpybind_front_type) & ::lola::vx::v4::NeuronBlock::AnalogValues::front,
			    "");
		}
		{
			typedef ::lola::vx::v4::NeuronBlock::AnalogValues::reference (
			    ::lola::vx::v4::NeuronBlock::AnalogValues::*genpybind_back_type)();
			av.def(
			    "back", (genpybind_back_type) & ::lola::vx::v4::NeuronBlock::AnalogValues::back,
			    "");
		}
		{
			typedef ::lola::vx::v4::NeuronBlock::AnalogValues::const_reference (
			    ::lola::vx::v4::NeuronBlock::AnalogValues::*genpybind_back_type)() const;
			av.def(
			    "back", (genpybind_back_type) & ::lola::vx::v4::NeuronBlock::AnalogValues::back,
			    "");
		}
		av.def(
		    "__getitem__", &::lola::vx::v4::NeuronBlock::AnalogValues::get, "",
		    parent->py::arg("key"), parent->py::return_value_policy::reference);
		av.def(
		    "__setitem__", &::lola::vx::v4::NeuronBlock::AnalogValues::set, "",
		    parent->py::arg("key"), parent->py::arg("value"));
		av.def(
		    "__iter__",
		    [av](::lola::vx::v4::NeuronBlock::AnalogValues& self) {
			    return pybind11::make_iterator(self);
		    },
		    parent->py::template keep_alive<0, 1>());

		av.def("to_numpy", [](::lola::vx::v4::NeuronBlock::AnalogValues const& self) {
			return ::halco::common::detail::to_numpy(self);
		});
		av.def(
		    "from_numpy",
		    [](::lola::vx::v4::NeuronBlock::AnalogValues& self, pybind11::array const& array) {
			    ::halco::common::detail::from_numpy(self, array);
		    });
		av.def(parent->py::template init<const ::lola::vx::v4::NeuronBlock::AnalogValues&>(), "");
		av.def(parent->py::template init<>(), "");
		av.def_property_readonly(
		    "size", parent->py::cpp_function(&::lola::vx::v4::NeuronBlock::AnalogValues::size));
		av.def_property_readonly(
		    "max_size",
		    parent->py::cpp_function(&::lola::vx::v4::NeuronBlock::AnalogValues::max_size));
		av.def_property_readonly(
		    "empty", parent->py::cpp_function(&::lola::vx::v4::NeuronBlock::AnalogValues::empty));
	})
private:
