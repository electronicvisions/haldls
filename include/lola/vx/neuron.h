...
{
public:
	typedef haldls::vx::CapMemCell::Value AnalogValue GENPYBIND(visible);
	typedef haldls::vx::CapMemCell::DisableRefresh AnalogDisableRefresh GENPYBIND(visible);
	typedef haldls::vx::CapMemCell::value_type AnalogValueVariant;
