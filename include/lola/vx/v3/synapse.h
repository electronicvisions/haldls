...
public:
	...
	typedef halco::hicann_dls::vx::v3::ColumnCorrelationRowOnDLS coordinate_type;

	typedef haldls::vx::v3::ColumnCorrelationQuad::ColumnCorrelationSwitch Value GENPYBIND(visible);
...
public:
	typedef std::false_type has_local_data;
	typedef halco::hicann_dls::vx::v3::ColumnCurrentRowOnDLS coordinate_type;

	typedef haldls::vx::v3::ColumnCurrentQuad::ColumnCurrentSwitch Value GENPYBIND(visible);
...
template <>
struct BackendContainerTrait<lola::vx::v3::ColumnCorrelationRow>
    : public BackendContainerBase<
          lola::vx::v3::ColumnCorrelationRow,
          fisch::vx::word_access_type::Omnibus,
          fisch::vx::word_access_type::OmnibusChipOverJTAG>
{};

template <>
struct VisitPreorderImpl<lola::vx::v3::ColumnCorrelationRow>
{
	typedef lola::vx::v3::ColumnCorrelationRow container_type;
	    ...
	    VisitorT&& visitor)
	{
		...
		for (auto const quad : iter_all<SynapseQuadColumnOnDLS>()) {
			haldls::vx::v3::ColumnCorrelationQuad quad_config;
...
template <>
struct BackendContainerTrait<lola::vx::v3::ColumnCurrentRow>
    : public BackendContainerBase<
...
template <>
struct VisitPreorderImpl<lola::vx::v3::ColumnCurrentRow>
{
	typedef lola::vx::v3::ColumnCurrentRow container_type;
	    ...
	    VisitorT&& visitor)
	{
		...
		for (auto const quad : iter_all<SynapseQuadColumnOnDLS>()) {
			haldls::vx::v3::ColumnCurrentQuad quad_config;
			for (auto const syn : iter_all<EntryOnQuad>()) {
				SynapseOnSynapseRow const syn_on_row(syn, quad);
				quad_config.m_switches[syn] = config.values[syn_on_row];
			}
...
BOOST_HANA_ADAPT_STRUCT(lola::vx::v3::ColumnCorrelationRow, values);
BOOST_HANA_ADAPT_STRUCT(lola::vx::v3::ColumnCurrentRow, values);
...
EXTERN_INSTANTIATE_CEREAL_SERIALIZE_FREE(lola::vx::v3::ColumnCorrelationRow)
EXTERN_INSTANTIATE_CEREAL_SERIALIZE_FREE(lola::vx::v3::ColumnCurrentRow)
