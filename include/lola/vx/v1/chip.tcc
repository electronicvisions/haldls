...
template <>
struct BackendContainerTrait<lola::vx::v1::Chip>
    : public BackendContainerBase<lola::vx::v1::Chip, fisch::vx::word_access_type::Omnibus>
{};

template <>
struct VisitPreorderImpl<lola::vx::v1::Chip>
{
	template <typename ContainerT, typename VisitorT>
	static void call(
	    ContainerT& config, lola::vx::v1::Chip::coordinate_type const& coord, VisitorT&& visitor)
	{
...
BOOST_HANA_ADAPT_STRUCT(
    ...
    ppu_memory,
    external_ppu_memory);
EXTERN_INSTANTIATE_CEREAL_SERIALIZE_FREE(lola::vx::v1::Chip)
