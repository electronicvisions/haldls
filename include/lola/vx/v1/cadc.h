...
public:
	...
	typedef halco::hicann_dls::vx::v1::CADCOnDLS coordinate_type;
	...
	{
	public:
		typedef haldls::vx::v1::CADCChannelConfig::Offset Offset GENPYBIND(visible);
	...
	typedef halco::common::
	    typed_array<Channel, halco::hicann_dls::vx::v1::CADCChannelColumnOnSynram>
	        ChannelArray GENPYBIND(opaque);

	typedef halco::common::typed_array<
	    haldls::vx::v1::CapMemCell::value_type,
	    halco::hicann_dls::vx::v1::CapMemBlockOnHemisphere>
	    AnalogValues;
	...
	{
	public:
		typedef haldls::vx::v1::CADCConfig::ResetWait ResetWait GENPYBIND(visible);
		typedef haldls::vx::v1::CADCConfig::DeadTime DeadTime GENPYBIND(visible);
	...
	{
		typedef haldls::vx::v1::CommonCorrelationConfig::SenseDelay SenseDelay GENPYBIND(visible);
		typedef haldls::vx::v1::CommonCorrelationConfig::ResetDuration ResetDuration
		    GENPYBIND(visible);
		typedef haldls::vx::v1::CommonCorrelationConfig::ResetFallTime ResetFallTime
		    GENPYBIND(visible);
		typedef haldls::vx::v1::CommonCorrelationConfig::ResetMode ResetMode GENPYBIND(visible);
		typedef haldls::vx::v1::CapMemCell::Value AnalogValue GENPYBIND(visible);
		typedef haldls::vx::v1::CapMemCell::DisableRefresh AnalogDisableRefresh GENPYBIND(visible);
	...
	// qualification
	GENPYBIND_MANUAL({
		auto av = parent->py::template class_<::lola::vx::v1::CADCReadoutChain::AnalogValues>(
		    parent, "AnalogValues");
		av.def(
		    "fill", &::lola::vx::v1::CADCReadoutChain::AnalogValues::fill, "",
		    parent->py::arg("val"));
		{
			typedef ::lola::vx::v1::CADCReadoutChain::AnalogValues::reference (
			    ::lola::vx::v1::CADCReadoutChain::AnalogValues::*genpybind_at_type)(
			    const ::lola::vx::v1::CADCReadoutChain::AnalogValues::key_type&);
			av.def(
			    "at", (genpybind_at_type) & ::lola::vx::v1::CADCReadoutChain::AnalogValues::at, "",
			    parent->py::arg("key"));
		}
		{
			typedef ::lola::vx::v1::CADCReadoutChain::AnalogValues::const_reference (
			    ::lola::vx::v1::CADCReadoutChain::AnalogValues::*genpybind_at_type)(
			    const ::lola::vx::v1::CADCReadoutChain::AnalogValues::key_type&) const;
			av.def(
			    "at", (genpybind_at_type) & ::lola::vx::v1::CADCReadoutChain::AnalogValues::at, "",
			    parent->py::arg("key"));
		}
		{
			typedef ::lola::vx::v1::CADCReadoutChain::AnalogValues::reference (
			    ::lola::vx::v1::CADCReadoutChain::AnalogValues::*genpybind_front_type)();
			av.def(
			    "front",
			    (genpybind_front_type) & ::lola::vx::v1::CADCReadoutChain::AnalogValues::front, "");
		}
		{
			typedef ::lola::vx::v1::CADCReadoutChain::AnalogValues::const_reference (
			    ::lola::vx::v1::CADCReadoutChain::AnalogValues::*genpybind_front_type)() const;
			av.def(
			    "front",
			    (genpybind_front_type) & ::lola::vx::v1::CADCReadoutChain::AnalogValues::front, "");
		}
		{
			typedef ::lola::vx::v1::CADCReadoutChain::AnalogValues::reference (
			    ::lola::vx::v1::CADCReadoutChain::AnalogValues::*genpybind_back_type)();
			av.def(
			    "back",
			    (genpybind_back_type) & ::lola::vx::v1::CADCReadoutChain::AnalogValues::back, "");
		}
		{
			typedef ::lola::vx::v1::CADCReadoutChain::AnalogValues::const_reference (
			    ::lola::vx::v1::CADCReadoutChain::AnalogValues::*genpybind_back_type)() const;
			av.def(
			    "back",
			    (genpybind_back_type) & ::lola::vx::v1::CADCReadoutChain::AnalogValues::back, "");
		}
		av.def(
		    "__getitem__", &::lola::vx::v1::CADCReadoutChain::AnalogValues::get, "",
		    parent->py::arg("key"), parent->py::return_value_policy::reference);
		av.def(
		    "__setitem__", &::lola::vx::v1::CADCReadoutChain::AnalogValues::set, "",
		    parent->py::arg("key"), parent->py::arg("value"));
		av.def(
		    "__iter__",
		    [av](::lola::vx::v1::CADCReadoutChain::AnalogValues& self) {
			    return pybind11::make_iterator(self);
		    },
		    parent->py::template keep_alive<0, 1>());

		av.def("to_numpy", [](::lola::vx::v1::CADCReadoutChain::AnalogValues const& self) {
			return ::halco::common::detail::to_numpy(self);
		});
		av.def(
		    "from_numpy",
		    [](::lola::vx::v1::CADCReadoutChain::AnalogValues& self, pybind11::array const& array) {
			    ::halco::common::detail::from_numpy(self, array);
		    });
		av.def(
		    parent->py::template init<const ::lola::vx::v1::CADCReadoutChain::AnalogValues&>(), "");
		av.def(parent->py::template init<>(), "");
		av.def_property_readonly(
		    "size",
		    parent->py::cpp_function(&::lola::vx::v1::CADCReadoutChain::AnalogValues::size));
		av.def_property_readonly(
		    "max_size",
		    parent->py::cpp_function(&::lola::vx::v1::CADCReadoutChain::AnalogValues::max_size));
		av.def_property_readonly(
		    "empty",
		    parent->py::cpp_function(&::lola::vx::v1::CADCReadoutChain::AnalogValues::empty));
	})
private:
...
template <>
struct BackendContainerTrait<lola::vx::v1::CADCReadoutChain>
    : public BackendContainerBase<
          lola::vx::v1::CADCReadoutChain,
          fisch::vx::word_access_type::Omnibus,
          fisch::vx::word_access_type::OmnibusChipOverJTAG>
{};

template <>
struct VisitPreorderImpl<lola::vx::v1::CADCReadoutChain>
{
	template <typename ContainerT, typename VisitorT>
	static void call(
	    ContainerT& config,
	    lola::vx::v1::CADCReadoutChain::coordinate_type const& coord,
	    VisitorT&& visitor)
	{
		...
		haldls::vx::v1::CADCConfig cadc_config;
		...
		if constexpr (!std::is_same<ContainerT, lola::vx::v1::CADCReadoutChain const>::value) {
		...
		for (auto const block : iter_all<CapMemBlockOnHemisphere>()) {
			haldls::vx::v1::CapMemCell cell_v_offset(config.ramp.v_offset[block]);
			haldls::vx::v1::CapMemCell cell_i_slope(config.ramp.i_slope[block]);
			haldls::vx::v1::CapMemCell cell_i_bias_comp(config.ramp.i_bias_comparator[block]);
			haldls::vx::v1::CapMemCell cell_i_bias_vreset_buf(
			    config.ramp.i_bias_vreset_buffer[block]);
			haldls::vx::v1::CapMemCell cell_v_bias_buf(config.ramp.v_bias_buffer[block]);
			haldls::vx::v1::CapMemCell cell_i_bias_ramp(config.correlation.i_bias_ramp[block]);
			haldls::vx::v1::CapMemCell cell_i_bias_store(config.correlation.i_bias_store[block]);
			haldls::vx::v1::CapMemCell cell_i_bias_corout(config.correlation.i_bias_corout[block]);
		...
		for (auto const column : iter_all<CADCChannelColumnOnSynram>()) {
			haldls::vx::v1::CADCChannelConfig channel_config;
		...
		lola::vx::v1::ColumnCorrelationRow column_correlation_row;
		...
		haldls::vx::v1::CommonCorrelationConfig correlation_config;
...
BOOST_HANA_ADAPT_STRUCT(
    lola::vx::v1::CADCReadoutChain, ramp, channels_causal, channels_acausal, correlation);
BOOST_HANA_ADAPT_STRUCT(
    lola::vx::v1::CADCReadoutChain::Channel,
    offset,
    enable_connect_correlation,
    enable_connect_debug,
    enable_connect_neuron);
BOOST_HANA_ADAPT_STRUCT(
    lola::vx::v1::CADCReadoutChain::Ramp,
    enable,
    reset_wait,
    dead_time,
    v_offset,
    ...
    v_bias_buffer);
BOOST_HANA_ADAPT_STRUCT(
    lola::vx::v1::CADCReadoutChain::Correlation,
    sense_delay,
    reset_duration,
    reset_fall_time,
    reset_mode,
...
EXTERN_INSTANTIATE_CEREAL_SERIALIZE_FREE(lola::vx::v1::CADCReadoutChain)
