...
class TestPylolaVXV1(unittest.TestCase):
    ...
    def test_neuron_leak(self):
        ...
        self.assertEqual(neuron.leak_reset.leak.v_leak, 0)
        value = random_ranged(lola.AtomicNeuron.AnalogValue)
        neuron.leak_reset.leak.v_leak = value
        self.assertEqual(neuron.leak_reset.leak.v_leak, value)

        self.assertEqual(neuron.leak_reset.leak.i_bias, 0)
        value = random_ranged(lola.AtomicNeuron.AnalogValue)
        neuron.leak_reset.leak.i_bias = value
        self.assertEqual(neuron.leak_reset.leak.i_bias, value)

        self.assertEqual(neuron.leak_reset.leak.enable_degeneration, False)
        neuron.leak_reset.leak.enable_degeneration = True
        self.assertEqual(neuron.leak_reset.leak.enable_degeneration, True)

        self.assertEqual(neuron.leak_reset.leak.enable_division, False)
        neuron.leak_reset.leak.enable_division = True
        self.assertEqual(neuron.leak_reset.leak.enable_division, True)

        self.assertEqual(neuron.leak_reset.leak.enable_multiplication, False)
        neuron.leak_reset.leak.enable_multiplication = True
        self.assertEqual(neuron.leak_reset.leak.enable_multiplication, True)
    ...
    def test_neuron_membrane(self):
        ...
        self.assertEqual(neuron.membrane_capacitance.enable_merge,
                         False)
